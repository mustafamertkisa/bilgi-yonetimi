...
<head>
  ...
  <style>
    ...
    #butongiris {width:92%; height: 30px; background-color: #d30b11; cursor: pointer; color: #ffff;}
...
<body>
  ...
  <div id = "girisform" align:'center'>
    <form action="islemgiris.php" method="POST">
      <table class="ortala">
        <tr>
          <td><h4 align="center"><font color="#d30b11" face="tahoma"> <br> Hatalı giriş! <br>Lütfen tekrar deneyiniz. <br><hr> &hearts; KAN VER HAYAT OL &hearts;</font></h4></td>
        </tr>
        <tr>
